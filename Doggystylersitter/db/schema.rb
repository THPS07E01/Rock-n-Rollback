...
ActiveRecord::Schema.define(version: 2019_01_31_203837) do
  ...
  create_table "dog_groups", force: :cascade do |t|
    t.integer "stroll_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["stroll_id"], name: "index_dog_groups_on_stroll_id"
  end

  create_table "dogs", force: :cascade do |t|
    t.integer "city_id"
    t.integer "dog_group_id"
    t.string "name"
    t.string "master"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_dogs_on_city_id"
    t.index ["dog_group_id"], name: "index_dogs_on_dog_group_id"
  end
