...
ActiveRecord::Schema.define(version: 2019_01_31_210804) do
  ...
  create_table "multi_recipients", force: :cascade do |t|
    t.integer "private_message_id"
    t.integer "recipient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["private_message_id"], name: "index_multi_recipients_on_private_message_id"
    t.index ["recipient_id"], name: "index_multi_recipients_on_recipient_id"
  end
